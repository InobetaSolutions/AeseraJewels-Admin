...
//         accessor: "actions",
//         Cell: ({ row }) =>
//           row.original.status !== "Payment Confirmed" ? (
//             <button
//               style={customButtonStyle}
//               size="sm"
//               onClick={() => approvePayment(row.original.id)}
...
//         console.log("Approve response:", resData);

//         setData((prev) =>
//           prev.map((p) =>
//             p.id === id ? { ...p, status: "Payment Confirmed" } : p
//           )
//         );
...
//         // ✅ Navigate after alert finishes
//         setTimeout(() => {
//           navigate("/app/Approved");
//         }, 1200);
//       } catch (error) {
//         Swal.fire({
//           title: "Error!",
...
//       try {
//         const response = await fetch(
//           "http://13.204.96.244:3000/api/cancelPayment",
//           {
//             method: "POST",
//             headers: {
//               "Content-Type": "application/json",
//               Authorization:
//                 "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJtb2JpbGUiOiI2MzgxNjE1MDUzIiwibmFtZSI6InBhcnRoYSIsImlhdCI6MTc1ODA5Mzg4MywiZXhwIjoxNzU4MjY2NjgzfQ.Q9hVum-bE1l2795UWTJXnQIVxHN6IZT1S1YFKYtJfpY",
//             },
//             body: JSON.stringify({ id }),
//           }
//         );
...
//         const resData = await response.json();
//         console.log("Cancel response:", resData);

//         if (resData.success) {
//           setData((prev) =>
//             prev.map((p) =>
//               p.id === id ? { ...p, status: "Payment Cancelled" } : p
//             )
//           );
...
//           Swal.fire({
//             title: "Error!",
//             text: resData.message || "Failed to cancel payment.",
//             icon: "error",
//           });
//         }
//       } catch (error) {
...
//         Swal.fire({
//           title: "Error!",
//           text: "Something went wrong while cancelling payment.",
//           icon: "error",
//         });
//       }
//     }
  ...
  const COLUMNS = React.useMemo(
    () => [
      ...
      },
      {
        Header: "Grams",
        accessor: "gram",
        Cell: ({ value }) => `${value ? value.toFixed(3) : '0.000'}g`,
