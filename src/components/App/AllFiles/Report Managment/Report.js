...
function CategoryManagement() {
 ...
 const navigate = useNavigate();
  ...
  const alldata =()=> {
    ...
    fetch(API_URL + `report_management`, requestOptions)
    ...
    <div>
     ...
     <FormGroup style={{ marginTop: 20, border: '1px solid #38cab3', borderRadius: 5 }} className="form-group">
      ...
      <Button 
       ...
       type="button"
       onClick={()=>navigate('/app/InvestementData')}
      >
        Investement Report
      </Button>
          ...
          <Card.Body>
            ...
            <span style={{fontSize:20}} >Agent Total Collection : <b>{total}</b></span>
