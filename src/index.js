...
// All files
const AgentMangement = React.lazy(() =>
  import("./components/App/AllFiles/Agent Managment/Agent")
);
const UserManagement = React.lazy(() =>
  import("./components/App/AllFiles/UserManagment/User.js")
);
...
const AgentCollection = React.lazy(() =>
  import("./components/App/AllFiles/AgentCollection/Agentcollection")
);
const InvestementData = React.lazy(() =>
  import("./components/App/AllFiles/InvestementData/Investement")
);
const CustomerCollectedAmount = React.lazy(() =>
  import("./components/App/AllFiles/CustomerCollectedAmont/CustomerCollected")
);
        ...
        <Routes>
          ...
          <Route path={`${process.env.PUBLIC_URL}/`} element={<App />}>
            ...
            <Route>
              ...
              <Route
                path={`${process.env.PUBLIC_URL}/app/AgentMangement`}
                element={<AgentMangement />}
              />
              ...
              />
              <Route
                path={`${process.env.PUBLIC_URL}/app/Addamc`}
                element={<Addamc />}
              />

              <Route
                path={`${process.env.PUBLIC_URL}/app/InvestementData`}
                element={<InvestementData />}
              />

              <Route
                path={`${process.env.PUBLIC_URL}/app/CustomerCollectedAmount`}
                element={<CustomerCollectedAmount />}
              />
